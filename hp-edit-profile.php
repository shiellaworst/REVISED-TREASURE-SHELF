...
if (isset($_POST['submit']))  {
    ...
    //     $hashed_password = password_hash($password, PASSWORD_DEFAULT);
        ...
        if (mysqli_query($conn, $sql)) {
            echo '<script>alert("Updated Succesfully"); window.location.href="hp-edit-profile.php";</script>';
            if ($error === 0) {
                if ($img_size > 6000000) {
                    $em = "Sorry, your file is too large.";
                    header("Location: hp-edit-profile.php?error=$em");
                }else {
...
<head>
    ...
    <title>TS | User-Profile | Edit Profile</title>
    ...
    <div class ="user-profile">
        ...
        <div class="cntn">
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="edit-con"  style="justify-content:center; display: flex;">
                    ...
                    <div class="img-prev">
                        ...
                        <div class="image-upload">
                            ...
                            <input style="" type="file" accept="image/*" id="my_image" name="my_image"  name="user_img" value="<?php echo "<img src='uploads/".$row['user_img']."' >";?>" >
                        </div>
                    </div>
